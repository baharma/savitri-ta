...
<form action="" method="POST" enctype='multipart/form-data' id="modal-hutang-edit" >
    @csrf
    @method('PUT')
<div class="modal fade" id="staticModalHutangedit" data-bs-backdrop="static" style="z-index: 1050;" data-bs-keyboard="false" tabindex="-12"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <x-layout.input  :label="'Tanggal Transaksi Hutang'" :type="'date'" :idname="'tgl_transaksi_hutang-edit'" :placeholder="'tgl_transaksi_piutang'" :name="'tgl_transaksi_hutang'" />
                        </div>
                        <div class="col">
                            <x-layout.input  :label="'Tanggal Jatuh Tempo'" :type="'date'" :idname="'tgl_jatuh_tempo-edit'" :placeholder="'tgl_jatuh_tempo'" :name="'tgl_jatuh_tempo'" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <x-layout.input  :label="'Total Transaksi Hutang'" :type="'number'" :placeholder="'Total Transaksi Hutang'" :name="'total_transaksi_hutang'" :idname="'total_transaksi_hutang-edit'" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <x-layout.input-large-groub label="Description" name="description_hutang" :idname="'description-hutang-id-edit'" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
