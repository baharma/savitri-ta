...
<div class="container-fluid">
    <div class="row">
        <form action="{{route('penjualan.index')}}" class="col">
            ...
            <div class="d-flex justify-content-end">
                <x-layout.add-modal-button>
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#staticModalPenjualan">
                        Tambah
                    </button>
                    @endslot
                    @slot('input')
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-info edit-this-modal" data-bs-toggle="modal"
                        data-edit="{{route('penjualan.update',$item->id)}}"
                        data-url="{{route('penjualan.edit',$item->id)}}" data-id="{{$item->id}}"
                        data-bs-target="#staticModalPenjualanEdit">
