                            ...
                            <div class="col-md-12" id="apps">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <select name="akun_id[]" v-model="item.akun_id" class="form-control">
                                        ...
                                        <td>
                                            <input type="number" name="kredit[]" id="" v-model="item.kredit" class="form-control">
                                        </td>
                                        <td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>@{{ formatCurrency(totalkredit) }}</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
...
<script>
        ...
        methods: {
            addItem() {
                this.items.push({
                id: this.index,
                akun_id: this.newItem.akun_id,
                debit: parseFloat(this.newItem.debit) || 0,
                kredit: parseFloat(this.newItem.kredit) || 0,
            });
                this.index++;
        ...
        computed:{
            ...
            totalkredit() {
                return this.items.reduce((sum, item) => sum + (parseFloat(item.kredit) || 0), 0);
            },
